...
#ggsave("./paper/figures/tiga_c036.eps", height=3, width=3)
...
#ggsave("./paper/figures/tiga_c02.eps", height=3, width=3)
...
#ggsave("./paper/figures/tiga_c05.eps", height=3, width=3)
```
...
#ggsave("./paper/figures/tiga_n30.eps", height=9, width=14, units="cm")
...
#ggsave("./paper/figures/hyp_fu_cl.eps", width = 10, height = 7, units="cm")
...
#ggsave("./paper/figures/hyp_ad_eff.eps", width = 10, height = 7, units="cm")
```
### Simulation model
...
#ggsave("./paper/figures/p_front.eps", width = 14, height = 9, units="cm")
```
...
#ggsave("./paper/figures/cost_OCs.eps", width = 17, height = 11, units="cm")
```
...
#ggsave("./paper/figures/an_prior_comp.eps", width = 14, height = 9, units="cm")
```
...
#ggsave("./paper/figures/k_comp.eps", width = 14, height = 9, units="cm")
```