...
for(k in c(18, 24)){
  ...
  for(i in 1:1000){
    ...
    o <- capture.output(  fit <- stan(file = './stan/WP2_ex_REACH_5_1.stan', 
    ...
    o <- capture.output(  fit2 <- stan(file = './stan/WP2_ex_REACH_5_2.stan', 
    ...
    o <- capture.output(  fit3 <- stan(file = './stan/WP2_ex_REACH_5_3.stan', 
